...
public class AddonService {
  ...
  private static AddonService _instance = null;

  public static AddonService getInstance() {
    if (_instance == null)
      _instance = new AddonService();
    return _instance;
  }
  ...
  public Class<?> loadJarClass(String jarFilePath, String fullyQualifiedName, Boolean isAction) throws MalformedURLException, ClassNotFoundException {
  ...
  private void loadSdkClassesActionClasses() throws ClassNotFoundException {
    log.info("Initiating NLP classes for execution");
    this.elementClass = loadClassFromJar(Element.class.getName());
  ...
  public Object getElementInstance(String locatorValue, By by) throws NoSuchMethodException,
    InvocationTargetException, InstantiationException, IllegalAccessException {
    return elementClass.getDeclaredConstructor(String.class, By.class)
      .newInstance(locatorValue, by);
  }
