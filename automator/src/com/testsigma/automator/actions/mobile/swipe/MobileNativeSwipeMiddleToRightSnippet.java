...
@Log4j2
public class MobileNativeSwipeMiddleToRightSnippet extends MobileElementAction {

  private static final String SUCCESS_MESSAGE = "Swiped middle to right element successfully";
  ...
  public void execute() throws Exception {
    ...
    Sequence swipe = new Sequence(pointer, 1)
            ...
            .addAction(pointer.createPointerMove(ofSeconds(5), viewport(), endx, starty))
