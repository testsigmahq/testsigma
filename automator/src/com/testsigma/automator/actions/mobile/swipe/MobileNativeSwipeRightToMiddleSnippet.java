...
@Log4j2
public class MobileNativeSwipeRightToMiddleSnippet extends MobileElementAction {

  private static final String SUCCESS_MESSAGE = "Swiped right to middle successfully";
