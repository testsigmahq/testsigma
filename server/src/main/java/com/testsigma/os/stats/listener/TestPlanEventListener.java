  ...
  public void OnTestPlanEvent(TestPlanEvent<TestPlan> event) {
    ...
    try {
      if (event.getEventType() == EventType.CREATE) {
        testsigmaOsStatsService.sendTestPlanStats(event.getEventData(), com.testsigma.os.stats.event.EventType.CREATE);
      } else if (event.getEventType() == EventType.DELETE) {
        testsigmaOsStatsService.sendTestPlanStats(event.getEventData(), com.testsigma.os.stats.event.EventType.DELETE);
      }
