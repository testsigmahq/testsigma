...
public class AddonPluginTestDataFunctionSpecification extends BaseSpecification<AddonPluginTestDataFunction> {

  public AddonPluginTestDataFunctionSpecification(final SearchCriteria criteria) {
    super(criteria);
  }
  ...
  @Override
  protected Expression<String> getPath(SearchCriteria criteria, Root<AddonPluginTestDataFunction> root) {
  ...
  @Override
  public Predicate toPredicate(Root<AddonPluginTestDataFunction> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
    Predicate predicate;
