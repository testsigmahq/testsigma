...
@Log4j2
public class TestsigmaUploader extends StorageUploader {
  ...
  public void upload(String srcFilePath, String destinationURL) {
    ...
    log.info(String.format("Uploading test asset to Testsigma storage, presigned-URL:%s, localFilePath:%s", destinationURL, srcFilePath));
