...
@Entity
@Table(name = "kibbutz_plugin_test_data_function_parameters")
@Data
public class KibbutzPluginTestDataFunctionParameter {
  ...
  private KibbutzPluginTestDataFunction pluginTestDataFunction;
