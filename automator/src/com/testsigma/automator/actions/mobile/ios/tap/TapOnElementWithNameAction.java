...
public class TapOnElementWithNameAction extends MobileElementAction {
  ...
  private static final String FAILURE_MESSAGE = "Elements are found with given locator <b>\"%s:%s\"</b>, " +
    "But none of the elements name is matching with given name <b>\"%s\"</b>.<br>Below are the " +
    "names for the elements found with the given locator.<br><b>%s</b>";
  ...
  protected void execute() throws Exception {
    ...
    for (WebElement element : getElements()) {
      ...
      if (elementName.equals(getTestData())) {
        element.click();
        isElementFound = true;
        break;
      }
