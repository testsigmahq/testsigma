...
@Log4j2
public class MobileNativeSwipeBottomToMiddleSnippet extends MobileElementAction {

  private static final String SUCCESS_MESSAGE = "Swiped from bottom to middle successfully.";
