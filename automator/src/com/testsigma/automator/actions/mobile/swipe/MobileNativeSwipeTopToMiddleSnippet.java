...
@Log4j2
public class MobileNativeSwipeTopToMiddleSnippet extends MobileElementAction {

  private static final String SUCCESS_MESSAGE = "Swiped top to middle successfully";
