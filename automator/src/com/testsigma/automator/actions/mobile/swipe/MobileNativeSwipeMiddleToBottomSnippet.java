...
@Log4j2
public class MobileNativeSwipeMiddleToBottomSnippet extends MobileElementAction {

  private static final String SUCCESS_MESSAGE = "Swiped middle to bottom successfully";
