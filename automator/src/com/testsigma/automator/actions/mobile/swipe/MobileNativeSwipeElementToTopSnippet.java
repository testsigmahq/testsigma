...
@Log4j2
public class MobileNativeSwipeElementToTopSnippet extends MobileElementAction {

  private static final String SUCCESS_MESSAGE = "Swiped on element to top successfully";
  ...
  public void execute() throws Exception {
    ...
    int startx = targetElement.getLocation().getX();
