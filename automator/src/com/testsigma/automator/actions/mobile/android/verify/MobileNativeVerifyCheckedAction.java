...
@Log4j2
public class MobileNativeVerifyCheckedAction extends MobileElementAction {

  private static final String SUCCESS_MESSAGE = "Verified checkbox is checked successfully";
  ...
  public void execute() throws Exception {
    ...
    if (checkable.equals(TRUE)) {
      if (!checked.equals(TRUE)) {
        throw new AutomatorException(String.format("The element corresponding to the locator <b>\"%s:%s\"</b> is not in checked" +
            " state",
