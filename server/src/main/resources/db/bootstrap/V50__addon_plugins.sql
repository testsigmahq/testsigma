...
(
  ...
  CONSTRAINT `fk_addon_id_in_addon_test_data_functions` FOREIGN KEY (`addon_id`) REFERENCES `addons` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8
  COLLATE = utf8_unicode_ci;
...
(
  ...
  CONSTRAINT `fk_test_data_function_id_in_addon_test_data_function_params` FOREIGN KEY (`test_data_function_id`) REFERENCES `addon_plugin_test_data_functions` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8
  COLLATE = utf8_unicode_ci;
