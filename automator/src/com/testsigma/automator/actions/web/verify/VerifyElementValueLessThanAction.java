...
public class VerifyElementValueLessThanAction extends ElementAction {
  private static final String SUCCESS_MESSAGE = "Successfully verified that the element value is less than given testdata";
  ...
  private static final String FAILURE_MESSAGE_MISMATCH = "The value of element corresponding to the locator <b>\"%s:%s\"<b/> " +
    "is not less than given testdata . <br>Actual(Expected to be lesser):%s<br>Expected:%s";
