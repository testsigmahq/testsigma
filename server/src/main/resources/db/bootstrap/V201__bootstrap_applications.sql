...
INSERT INTO `workspaces` (`id`, `type`, `description`, `name`, `is_demo`, `created_date`, `updated_date`) VALUES (29,'MobileWeb','Demos how Testsigma simplifies iOS Native Workspace automation.','Responsive Web (Demo)', true, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
...
INSERT INTO `workspaces` (`id`, `type`, `description`, `name`, `is_demo`, `created_date`, `updated_date`) VALUES (31,'IOSNative','Testsigma Simply travel is demo site. Here we will be showing how to achieve responsive web testing with Testsigma.','iOS app (Demo)', true, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
