  ...
  public void OnTestStepEvent(TestStepEvent<TestStep> event) {
    ...
    try {
      if (event.getEventType() == EventType.CREATE) {
        testsigmaOsStatsService.sendTestStepStats(event.getEventData(), com.testsigma.os.stats.event.EventType.CREATE);
      } else if (event.getEventType() == EventType.DELETE) {
        testsigmaOsStatsService.sendTestStepStats(event.getEventData(), com.testsigma.os.stats.event.EventType.DELETE);
      }
