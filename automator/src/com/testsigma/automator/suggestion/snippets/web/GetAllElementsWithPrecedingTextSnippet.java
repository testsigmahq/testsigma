...
public class GetAllElementsWithPrecedingTextSnippet extends SuggestionSnippet {
  @Override
  protected void execute() throws Exception {
    ...
    Assert.isTrue((preceedingTexts.size() != 0), String.valueOf(SuggestionSnippetResult.Failure));
