...
public class SwitchToWindowByTitleAction extends ElementAction {

  private static final String SUCCESS_MESSAGE = "Successfully switched to a window with title <b>%s</b>.";
  ...
  protected void execute() throws Exception {
    ...
    try {
      for (String window : windowHandles) {
        ...
        if (title.equalsIgnoreCase(getTestData())) {
          isWindowFound = true;
          break;
        }
      }
