...
@Log4j2
public class MobileNativeSwipeMiddleToTopSnippet extends MobileElementAction {

  private static final String SUCCESS_MESSAGE = "Swiped middle to top successfully";
