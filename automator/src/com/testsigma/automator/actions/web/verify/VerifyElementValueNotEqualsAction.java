...
public class VerifyElementValueNotEqualsAction extends ElementAction {
  private static final String SUCCESS_MESSAGE = "Successfully verified that the element value is not equal to testdata";
  ...
  private static final String FAILURE_MESSAGE_MISMATCH = "The value of element corresponding to the locator <b>\"%s:%s\"<b/> " +
    "is <b>Equals</b> to given testdata . <br>Actual(Expected to be not equal):%s<br>Expected:%s";
