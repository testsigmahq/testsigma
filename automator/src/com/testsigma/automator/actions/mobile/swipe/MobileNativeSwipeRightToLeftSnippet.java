...
@Log4j2
public class MobileNativeSwipeRightToLeftSnippet extends MobileElementAction {

  private static final String SUCCESS_MESSAGE = "Swiped from right to left successfully";
