...
public class VerifyElementValueGreaterThanOrEqualsAction extends ElementAction {
  private static final String SUCCESS_MESSAGE = "Successfully verified that the element value is greater/equal to testdata";
  ...
  private static final String FAILURE_MESSAGE_MISMATCH = "The value of element corresponding to the locator <b>\"%s:%s\"<b/> " +
    "is <b>Less</b> than given testdata . <br>Actual(Expected to be greater or equal):%s<br>Expected:%s";
  ...
  protected void execute() throws Exception {
    ...
    Assert.isTrue((actualValue >= expectedValue), String.format(FAILURE_MESSAGE_MISMATCH, getFindByType(), getLocatorValue(), actualValueString, getTestDataMaskResult()));
